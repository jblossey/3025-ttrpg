      ...
      <div className="flex items-end gap-2">
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            className="rounded border border-primary/20 bg-card/60 px-2 py-1.5 font-mono text-[10px] text-foreground/80 outline-none backdrop-blur-sm focus:border-primary/40"
          >
