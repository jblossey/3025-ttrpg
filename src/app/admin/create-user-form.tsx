      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            className="w-full rounded border border-primary/20 bg-card/60 px-3 py-1.5 font-mono text-[10px] text-foreground/80 outline-none backdrop-blur-sm transition-all focus:border-primary/40 focus:shadow-[0_0_8px_rgba(var(--primary-rgb,0,180,255),0.1)]"
          >
